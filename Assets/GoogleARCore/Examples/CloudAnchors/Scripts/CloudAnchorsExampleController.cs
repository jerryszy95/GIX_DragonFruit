...
#pragma warning restore 618
        ...
        private bool _isDragonFruit()
        {
            // if there is a dragonFruit generated by the local player, return true, eles return false
            return GameObject.Find("LocalPlayer").GetComponent<LocalPlayerController>().LocalIsDragonFruit();
